...
class QuestionEmbedding(nn.Module):
    ...
    def init_hidden(self, batch):
        ...
        weight = torch.empty(3072, 600).to('cuda')
    ...
    def forward(self, x):
        ...
        assert( not forward_.isnan().any())
        assert( not backward.isnan().any())
